	...
	$effect(() => {
		...
		untrack(() => {
			...
			if ($formData.openingHours !== newHours) {
				$formData.openingHours = newHours;
			}
		});
	});
				...
				<div class="space-y-2">
					...
					>
						...
						{:else}
							...
							<option value="A partir de R$ 50">A partir de R$ 50</option>
							<option value="A partir de R$ 100">A partir de R$ 100</option>
							<option value="A partir de R$ 250">A partir de R$ 250</option>
			...
			<Form.Field {form} name="number" class="space-y-2 md:col-span-3">
				<Form.Control>
					{#snippet children({ props })}
						...
						<Input {...props} bind:value={$formData.number} placeholder="S/N" />
					{/snippet}
				</Form.Control>
				<Form.FieldErrors />
			</Form.Field>
			...
			<Form.Field {form} name="complement" class="space-y-2 md:col-span-9">
				<Form.Control>
					{#snippet children({ props })}
						...
						<Input {...props} bind:value={$formData.complement} placeholder="Apto, Sala..." />
					{/snippet}
				</Form.Control>
				<Form.FieldErrors />
			</Form.Field>
